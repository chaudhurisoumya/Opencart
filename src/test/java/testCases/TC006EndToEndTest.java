...
public class TC006EndToEndTest extends BaseClass {
	...
	//regpage.setTelephone("1234567");  //This is applicable only for the web application
	regpage.setPassword("test123");
	//regpage.setConfirmPassword("test123"); //This is applicable only for the web application
	...
	Thread.sleep(3000);
	ch.clickOnChooseShippingMethod();
	Thread.sleep(1000);
	ch.clickOnChoosePaymentMethod();
	//ch.clickOnContinueAfterDeliveryAddress();
	Thread.sleep(1000);
	ch.setDeliveryMethodComment("Test Automation");
	Thread.sleep(1000);
